...
// Si la moyenne est supérieure ou égale à 10 => mention "Passable"
// Sinon => mention "Insuffisant"
...
const car = {
    ...
    description: function () { return `La voiture est une ${this.marque} ${this.modele} ${this.couleur}` },
